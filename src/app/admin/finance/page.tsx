  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col md:flex-row">
      ...
      <nav className="fixed bottom-0 left-0 right-0 h-20 bg-white border-t flex md:hidden items-center justify-around px-2 z-50 overflow-x-auto">
        ...
        <Link href="/admin/finance" className="flex flex-col items-center gap-1 text-primary min-w-[60px]">
          <Wallet className="h-5 w-5" />
          <span className="text-[10px] font-black uppercase">Financeiro</span>
        </Link>
